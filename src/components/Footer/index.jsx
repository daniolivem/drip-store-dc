    ...
    <footer className="footer">
            ...
            <div className="footer-info">
                <nav>
                    <ul className="footer-info-list">
                        <li className="footer-info-title"><strong>Informações</strong></li>
            ...
            <div className="footer-categories">
                <nav>
                    <ul className="footer-categories-list">
                        <li className="footer-categories-title"><strong>Categorias</strong></li>
        ...
        <div className="footer-social">
            ...
            <div className="footer-line">
                <svg xmlns="http://www.w3.org/2000/svg" width="1240" height="1" viewBox="0 0 1240 1" fill="none">
