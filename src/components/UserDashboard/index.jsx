...
export default function UserDashboard() {
            ...
            <div className="orders-list">
                {orders.map((order) => (
                    <div key={order.id} className="order-item">
                        ...
                        <div className={`status ${order.statusClass}`}>
                            {order.status}
                        </div>
                    </div>
                ))}
    ...
    const containerClass = activeSection === 'Meus Pedidos' 
    ...
    return (
        <div className={containerClass}>
            ...
            {/* Main Content */}
            <div className={activeSection === 'Meus Pedidos' ? 'main-content' : 'profile-main-content'}>
                {renderContent()}
            </div>
        </div>
    );
